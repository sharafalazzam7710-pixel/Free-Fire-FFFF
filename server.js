...
function normalizeSettings(value = {}) {
  const merged = { ...DEFAULT_STATE.settings, ...(value || {}) };
  const savedPreference = value?.registrationAfterFinish || value?.registration || DEFAULT_STATE.settings.registrationAfterFinish;
